...
export default class DrawLines {
    ...
    lining(x) {
		...
		//for (let i = 0; i < x.length; i++) {
		//if(counter>1){
		//	console.log('pointerzzerrrr')
		//		x[i].disabled = false
		//	}else{
		//		if(i == pointer){
		//			console.log('pointerzz')
		//			x[i].disabled = true
		//		}else{
		//			console.log('pointerzz')
		//			x[i].disabled = false
            ...
            if (komer4 > 0 && komer4 < 1) {
                ...
                if (this.kockice[1] === 1) {
                    ...
                    if (this.dzoker === 2) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(2 * this.halfStepW, 0,2)
                ...
                if (this.kockice[2] === 1) {
                    if (this.dzoker === 3) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(4 * this.halfStepW, 0,3)
                ...
                if (this.kockice[3] === 1) {
                    if (this.dzoker === 4) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(6 * this.halfStepW, 0,4)
                ...
                if (this.kockice[4] === 1) {
                    ...
                    if (this.dzoker === 5) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(8 * this.halfStepW, 0,5)
                        this.pomocniNiz = [(this.linez[1] > 0) ? 2 : 0, (this.linez[5] > 0) ? 6 : 0]
            ...
            if (komer4 > 0 && komer4 < 1) {
                ...
                if (this.kockice[5] === 1) {
                    ...
                    if (this.dzoker === 6) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(0, 2 * this.halfStep,6)
                ...
                if (this.kockice[6] === 1) {
                    ...
                    if (this.dzoker === 7) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(2 * this.halfStepW, 2 * this.halfStep,7)
                ...
                if (this.kockice[7] === 1) {
                    ...
                    if (this.dzoker === 8) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(4 * this.halfStepW, 2 * this.halfStep,8)
                ...
                if (this.kockice[8] === 1) {
                    ...
                    if (this.dzoker === 9) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(6 * this.halfStepW, 2 * this.halfStep,9)
                ...
                if (this.kockice[9] === 1) {
                    ...
                    if (this.dzoker === 10) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(8 * this.halfStepW, 2 * this.halfStep,10)
            ...
            if (komer4 > 0 && komer4 < 1) {
                ...
                if (this.kockice[10] === 1) {
                    ...
                    if (this.dzoker === 11) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(0, 4 * this.halfStep,11)
                ...
                if (this.kockice[11] === 1) {
                    ...
                    if (this.dzoker === 12) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(2 * this.halfStepW, 4 * this.halfStep,12)
                ...
                if (this.kockice[12] === 1) {
                    if (this.dzoker === 13) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(4 * this.halfStepW, 4 * this.halfStep,13)
                ...
                if (this.kockice[13] === 1) {
                    ...
                    if (this.dzoker === 14) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(6 * this.halfStepW, 4 * this.halfStep,14)
                ...
                if (this.kockice[14] === 1) {
                    ...
                    if (this.dzoker === 15) {
                        ...
                        this.ocistiCanvas()
                        this.crtacKockica()
                        this.dodajDzokera(8 * this.halfStepW, 4 * this.halfStep,15)
